...
// o tensor com o status do grid de forma global.
#define N 20
...
// Essa modelagem possibilita que threads entrem em espera sem necessidade ou
// sejam acordadas sem que tenha acontecido alguma mudança na posição que
// as interessa.
